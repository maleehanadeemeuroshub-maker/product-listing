...
export default function Footer() {
  return (
    <footer className="w-full bg-slate-50 border-t border-slate-900/10 mt-20 pt-16 pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Value Propositions Banner */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 pb-16 border-b border-slate-900/10">
          <div className="flex items-start gap-4 p-4 rounded-2xl glass-panel border border-slate-900/6">
            <div className="p-3 rounded-xl bg-cyan-500/10 text-cyan-400">
              <Box className="w-6 h-6" />
            </div>
            <div>
              <h4 className="text-sm font-semibold text-slate-900">Real-Time 3D Engine</h4>
              <p className="text-xs text-slate-500 mt-1">Interactive 60fps WebGL rendering with exploded teardown views.</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4 p-4 rounded-2xl glass-panel border border-slate-900/6">
            ...
            <div>
              <h4 className="text-sm font-semibold text-slate-900">Global Express Freight</h4>
              <p className="text-xs text-slate-500 mt-1">Free carbon-neutral courier on all orders over $150.</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4 p-4 rounded-2xl glass-panel border border-slate-900/6">
            ...
            <div>
              <h4 className="text-sm font-semibold text-slate-900">3-Year Precision Care</h4>
              <p className="text-xs text-slate-500 mt-1">Complimentary hardware warranty & express part replacements.</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4 p-4 rounded-2xl glass-panel border border-slate-900/6">
            ...
            <div>
              <h4 className="text-sm font-semibold text-slate-900">30-Day Risk-Free Trial</h4>
              <p className="text-xs text-slate-500 mt-1">Experience true spatial acoustic and computing bliss or 100% refund.</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-10 py-12">
          <div className="md:col-span-2">
            <div className="flex items-center gap-2.5 mb-4">
              ...
              <span className="text-xl font-bold tracking-tight font-['Space_Grotesk'] text-slate-900">
          ...
          <div>
            <h4 className="text-xs font-mono uppercase tracking-widest text-slate-600 font-semibold mb-4">
              Showcase Labs
            </h4>
          ...
          <div>
            ...
            <form onSubmit={(e) => { e.preventDefault(); sound.playClick(); alert('Subscribed to AURA 3D Inner Circle!'); }} className="space-y-2">
              <input
                ...
                className="w-full px-3.5 py-2 text-xs rounded-xl bg-white border border-slate-900/10 text-slate-700 placeholder:text-slate-500 focus:outline-none focus:border-cyan-500"
              />
              <button
                type="submit"
        ...
        {/* Bottom Bar */}
        <div className="pt-8 border-t border-slate-900/6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500 font-mono">
          ...
          <div className="flex items-center gap-6">
            ...
            <a href="#" className="hover:text-slate-600 transition-colors">Terms of Experience</a>
            <a href="#" className="hover:text-slate-600 transition-colors">System Telemetry</a>
          </div>
        </div>
